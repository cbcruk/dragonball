    ...
    <head>
      ...
      */
        #templateHeader {
          ...
          /*@editable*/
          background-image: url('https://gallery.mailchimp.com/36b4d3c192a2c248ee9f896dc/_compresseds/ad5e5a66-15cb-4a3e-8799-a588a13f9acf.jpg');
          /*@editable*/
      ...
      */
        .lowerColumnHeaderContainer .mcnTextContent,
        .lowerColumnHeaderContainer .mcnTextContent p {
          /*@editable*/
          color: #202020;
          /*@editable*/
          font-family: 'Roboto', 'Helvetica Neue', Helvetica, Arial, sans-serif;
      ...
      */
        .lowerColumnHeaderContainer .mcnTextContent a,
        .lowerColumnHeaderContainer .mcnTextContent p a {
          /*@editable*/
          color: #4872dd;
          /*@editable*/
          font-weight: normal;
